...
Commence par `HRD-003`, décrite dans [`specs/modules/hardening/tasks.md`](specs/modules/hardening/tasks.md). Ne poursuis pas automatiquement vers `HRD-004` tant que `HRD-003` n’est pas fusionnée et documentée.
