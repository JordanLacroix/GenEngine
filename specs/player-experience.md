...
Le familier joueur accepte une définition publiée, une image HTTPS, un nom personnel, un niveau d'aide, une fréquence, une préférence proactive et un **ensemble d'axes de personnalisation catalogués**.
